...
/***/ function(module, exports, __webpack_require__) {
	...
	var Drawer = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchGitHub = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'col-sm-12', style: { marginBottom: 15 } },
	            React.createElement(
	                'form',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var tweenState = __webpack_require__(229);
	...
	var Profile = React.createClass({
	    ...
	    init: function init() {
	        ...
	        helpers.getGitHubInfo(this.getParams().username).then((function (dataObj) {
	            this.setState({ bio: dataObj.bio, repos: dataObj.repos });
	        }).bind(this));
	    },
	    componentDidMount: function componentDidMount() {
	        this.ref = new Firebase('https://blistering-torch-4532.firebaseio.com/');
	        this.init();
	    },
	    componentWillUnmount: function componentWillUnmount() {
	        this.unbind('notes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NoteList = __webpack_require__(203);
